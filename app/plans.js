...
window.Plans = (function () {
  ...
  const EX = {
    ...
    COND: ["Conditioning", "cardio", "activity"],
    RUN: ["Run", "cardio", "cardio"],
    WALK: ["Walk", "cardio", "cardio"],
    STRETCH: ["Stretching", "other", "activity"],
    SHR: ["Shrimps & Bridges", "core", "activity"],
    HIP: ["Hip Mobility", "other", "activity"],
    NECK: ["Neck Routine", "other", "activity"],
    DRILL: ["Positional Drilling", "other", "activity"],
    SPAR: ["Live Rolling", "other", "activity"],
    // ── drilling / technique (used by the Drills plans; great with a dummy) ──
    SOLO: ["Solo Movement Drills", "other", "activity"],
    DUMMY: ["Dummy Drilling", "other", "activity"],
    FLOW: ["Flow Drilling", "other", "activity"],
    SHADOW: ["Shadow Grappling", "other", "activity"],
    SCRAM: ["Scramble Drills", "other", "activity"],
  };

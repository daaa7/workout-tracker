...
const CACHE = "groove-v34";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js", "./config.js", "./checkout.js", "./pro.js", "./templates.js", "./plans.js", "./manifest.json", "./icon.svg", "./vendor/supabase.js"];
